...
st.markdown("""
This page lets you explore **individual player ratings and statistics** for selected matches across different leagues and matchdays.

- Filter by league, game week, and match to view the specific game you're interested in.
- For each match, you'll find:
  - The **average team rating**
  - Each player's **individual match rating**
  - Their **match-specific stats** across key areas (attack, passing, defense, possession)
...
- For European competitions, please note:
  - **J17**: Final
  - **J16**: Semi-final (2nd leg)
  - **J15**: Semi-final (1st leg)
""")
